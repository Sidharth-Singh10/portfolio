    ...
    return (
      <Html lang="en" className="scroll-smooth">
        <Head>
          ...
          <meta
            name="description"
            content="Welcome to my personal blog where I share my idle thoughts. I am a Computer Science undergraduate passionate student about backend development, system architecture, and open-source contributions"
          />
